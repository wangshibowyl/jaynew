    ...
    void DoWindow(int id)
    {
        ...
        GUILayout.BeginVertical("", "topbar", GUILayout.Height(MainUI.statusBarHeight));
        {
            ...
            GUILayout.BeginHorizontal();
            {
                ...
                GUILayout.FlexibleSpace();
                if (GUILayout.Button("È·¶¨", "graybutton"))
                {
                    HideWindow();
                }
            }
                    ...
                    GUILayout.BeginVertical("", mListStyle);
                    {
                        ...
                        GUILayout.BeginHorizontal();
                        {
                            ...
                            GUILayout.BeginVertical();
                            {
                                ...
                                GUILayout.Label("<color=#989898><size=20>" + CSVReader.getString(mCSV, i.ToString(), "cost") + "½Ü±Ò" + "</size></color>");
                            }
                            GUILayout.EndVertical();
                            ...
                            GUILayout.BeginVertical();
                            {
                                ...
                                {
                                    GUILayout.Label("<color=#989898><size=16>ÉÐÎ´¹ºÂò" + "</size></color>");
                                    if (GUILayout.Button("¹ºÂò", "graybutton"))
                                    {
